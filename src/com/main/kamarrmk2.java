...
public class kamarrmk2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        kmrscrlLayout.setHorizontalGroup(
            ...
            .addGroup(kmrscrlLayout.createSequentialGroup()
                ...
                .addGap(5, 5, 5)
                .addComponent(txt_rmk, javax.swing.GroupLayout.PREFERRED_SIZE, 720, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(kmrscrlLayout.createSequentialGroup()
                .addGap(52, 52, 52)
    ...
    private void kmr1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr1MouseClicked
        ...
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,rumah_kost.deskripsi_rmk "
                    ...
                    + "WHERE kamar.nomor_kamar='1' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,client.*,rumah_kost.* FROM kamar INNER JOIN client ON client.id_kamar=kamar.id_kamar INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar=1 AND rumah_kost.id_rumahkost='2'";
...
//Data Client
    ...
    private void kmr2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr2MouseClicked
        ...
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    ...
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='2' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            ...
                            "WHERE kamar.nomor_kamar='2'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr3MouseClicked
        ...
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='3' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='3'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr4MouseClicked
        ...
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='4' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='4'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr_5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr_5MouseClicked
        ...
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='5' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='5'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr_6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr_6MouseClicked
        ...
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='6' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='6'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr_8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr_8MouseClicked
        ...
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='8' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='8'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr_7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr_7MouseClicked
       clear();
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='7' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='7'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr_9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr_9MouseClicked
        ...
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='9' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='9'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr10MouseClicked
       clear();
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='10' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='10'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr_11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr_11MouseClicked
        ...
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='11' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='11'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr_12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr_12MouseClicked
        ...
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='12' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='12'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr_13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr_13MouseClicked
        ...
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='13' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='13'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr_14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr_14MouseClicked
       clear();
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='14' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='14'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr_15MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr_15MouseClicked
       clear();
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='15' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='15'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr_16MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr_16MouseClicked
       clear();
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='16' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='16'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr_17MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr_17MouseClicked
       clear();
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='17' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='17'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr_18MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr_18MouseClicked
        ...
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='18' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='18'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr_19MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr_19MouseClicked
        ...
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='19' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='19'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void kmr_20MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kmr_20MouseClicked
        ...
        try {
            String sql = "SELECT kamar.*,rumah_kost.nama_rumahkost,"
                    + "rumah_kost.deskripsi_rmk FROM kamar JOIN rumah_kost "
                    + "ON rumah_kost.id_rumahkost=kamar.id_rumahkost WHERE kamar.nomor_kamar='20' AND kamar.id_rumahkost='2'";
            String sql1 = "SELECT kamar.*,\n" +
                            "client.*,\n" +
                            "rumah_kost.* \n" +
                            "FROM kamar \n" +
                            "INNER JOIN client ON client.id_kamar = kamar.id_kamar \n" +
                            "INNER JOIN rumah_kost ON rumah_kost.id_rumahkost=kamar.id_rumahkost \n" +
                            "WHERE kamar.nomor_kamar='20'AND rumah_kost.id_rumahkost='2'";
            Connection conn= (Connection)Koneksi.koneksiDB();
            java.sql.Statement stm =  conn.createStatement();
            java.sql.Statement stm1 =  conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
